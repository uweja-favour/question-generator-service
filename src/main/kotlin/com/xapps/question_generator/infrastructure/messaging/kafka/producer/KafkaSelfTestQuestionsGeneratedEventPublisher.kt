...
interface QuestionsGeneratedEventPublisher {
    fun publishQuestionsGenerated(event: QuestionsGeneratedEvent)
}

@Component
class KafkaSelfTestQuestionsGeneratedEventPublisher(
