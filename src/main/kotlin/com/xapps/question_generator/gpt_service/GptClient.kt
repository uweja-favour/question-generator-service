...
interface GptClient {
     ...
     */
    suspend fun generateJsonResponse(prompt: String, allowGpt5: Boolean = true): JsonObject

    /**
     * Sends a prompt to GPT and expects a plain string response.
     */
    suspend fun generateStringResponse(prompt: String, allowGpt5: Boolean = true): String
}